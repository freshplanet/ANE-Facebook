...
public abstract class PickerFragment<T extends GraphObject> extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listView = (ListView) view.findViewById(AirFacebookExtension.context.getResourceId("id.com_facebook_picker_list_view"));
    ...
    String getDefaultDoneButtonText() {
        return getString(AirFacebookExtension.context.getResourceId("string.com_facebook_picker_done_button_text"));
    }
    ...
    private void inflateTitleBar(ViewGroup view) {
        ViewStub stub = (ViewStub) view.findViewById(AirFacebookExtension.context.getResourceId("id.com_facebook_picker_title_bar_stub"));
        if (stub != null) {
            ...
            doneButton = (Button) view.findViewById(AirFacebookExtension.context.getResourceId("id.com_facebook_picker_done_button"));
            if (doneButton != null) {
            ...
            titleTextView = (TextView) view.findViewById(AirFacebookExtension.context.getResourceId("id.com_facebook_picker_title"));
            if (titleTextView != null) {
